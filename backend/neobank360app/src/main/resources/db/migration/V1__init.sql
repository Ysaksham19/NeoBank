-- ============================================================
-- NEO BANK - COMPLETE INITIAL SCHEMA
-- Sprint 1 Final Database Schema
-- ============================================================
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    ledger_balance_after DECIMAL(19,2)
        NOT NULL,
...
(type_code, type_name, minimum_balance, description)
...
('CURRENT',
 'Current Account',
 5000.00,
 'Minimum balance ₹5,000 required'),
...
(branch_code, branch_name, city, state, address, ifsc_code)
